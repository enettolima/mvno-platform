...
(function($) {
	...
	$(function () {
		...
		$("body").append('<iframe class="__historyFrame" src="' + $.history._cache + '" style="border:0px; width:0px; height:0px; visibility:hidden;" />');
		...
		$.history.intervalId = $.history.intervalId || window.setInterval(function () {
				...
				var cursor = $(".__historyFrame").contents().attr('location').toString().split('#')[1];
